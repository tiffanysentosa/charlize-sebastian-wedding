...
export async function POST(request: Request) {
  ...
  const result = await saveRsvp({
    ...
    plusOne: guest.scheduleType === "extended" ? clean(body.plusOne, 20) : "not-allotted",
    ...
    partySize: guest.scheduleType === "extended" && clean(body.plusOne, 20) === "yes" ? "2" : attending === "yes" ? "1" : "0",
